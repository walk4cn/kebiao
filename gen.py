...
TGT = ['土木3231', '土木3232', '土木3233', '土木3234', '土木3241', '土木3242', '造价3241', '造价3242']
...
io.open('课表数据.csv', 'w', encoding='utf-8-sig').write('\n'.join(csv) + '\n')
...
print('班级', [c for c, _ in sel], '课程', len(courses), '节次行', len(periods), file=__import__('sys').stderr)
